...
def get_number():
    ...
    def find_question(window_screenshot):
        ...
        left_number_x1 = int(config.LEFT_NUMBER_X1 * scale_x-25)
        left_number_x2 = int(config.LEFT_NUMBER_X2 * scale_x-25)
        left_number_y1 = int(config.LEFT_NUMBER_Y1 * scale_y)+80
        left_number_y2 = int(config.LEFT_NUMBER_Y2 * scale_y)+80

        right_number_x1 = int(config.RIGHT_NUMBER_X1 * scale_x+25)
        right_number_x2 = int(config.RIGHT_NUMBER_X2 * scale_x+25)
        right_number_y1 = int(config.RIGHT_NUMBER_Y1 * scale_y)+80
        right_number_y2 = int(config.RIGHT_NUMBER_Y2 * scale_y)+80
        # 在 img 中画出左边数字的候选框
        cv2.rectangle(
            img,
        ...
        right_number = img[right_number_y1:right_number_y2, right_number_x1:right_number_x2]
